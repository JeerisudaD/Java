...
//fruitMap.put("Apple",20); auto casting does not work in collections and maps
        ...
        //if the key duplicate java will retrieve the lase value (overwritten/resign)
        System.out.println(fruitMap);
        System.out.println(fruitMap.get("Kiwi"));
        System.out.println(fruitMap.get("KIWI"));// null case sensitive

        fruitMap.remove("Mango");//remove key
        System.out.println(fruitMap);

        System.out.println(fruitMap.containsKey("Kiwi"));//true
        System.out.println(fruitMap.containsKey("Papaya"));//false
